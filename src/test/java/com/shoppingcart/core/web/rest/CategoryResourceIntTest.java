...
import com.shoppingcart.core.repository.CategoryRepository;
...
public class CategoryResourceIntTest {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCategoryTitle()).isEqualTo(DEFAULT_CATEGORY_TITLE);
    }
    ...
    @Test
    @Transactional
    public void checkCategoryTitleIsRequired() throws Exception {
        int databaseSizeBeforeTest = categoryRepository.findAll().size();
        // set the field null
        category.setCategoryTitle(null);
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getCategoryTitle()).isEqualTo(UPDATED_CATEGORY_TITLE);
    }
