...
import { ICoupon, Coupon, DiscountType } from 'app/shared/model/shoppingcart/coupon.model';
...
describe('Service Tests', () => {
  describe('Coupon Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Coupon(0, 0, DiscountType.RATE, 0);
    });
