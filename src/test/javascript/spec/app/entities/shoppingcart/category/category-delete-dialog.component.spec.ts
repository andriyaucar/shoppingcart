...
import { CategoryDeleteDialogComponent } from 'app/entities/shoppingcart/category/category-delete-dialog.component';
import { CategoryService } from 'app/entities/shoppingcart/category/category.service';
